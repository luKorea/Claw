...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::settings::list_api_key_statuses,
            commands::settings::set_api_key,
            commands::settings::delete_api_key,
            commands::settings::get_api_key,
            commands::settings::sync_api_key_status,
            ...
            commands::conversation::delete_conversations,
            ...
            commands::custom_provider::list_custom_provider_models,
            commands::custom_provider::test_custom_provider_chat,
            commands::custom_provider::list_custom_providers,
            ...
            commands::mcp::refresh_mcp_server_tools,
